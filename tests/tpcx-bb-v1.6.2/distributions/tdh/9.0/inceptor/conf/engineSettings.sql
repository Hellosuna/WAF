...
set hive.default.fileformat=${hiveconf:BIG_BENCH_hive_default_fileformat_tmp_table};
...
set ngmr.reader.rowfilter=true;
set inceptor.mapjoin.filter=true;
set hive.cbo.enable=false;
set inceptor.join.discardnull=false;

set inceptor.filterjoin.enabled=true;
set inceptor.filterjoin.pushdown.filter.enabled=true;
...
--common
set character.literal.as.string;
--optimize
set inceptor.optimizer.on;
set ngmr.reader.minmaxfilter;
set ngmr.reader.rowfilter;
set inceptor.mapjoin.filter;
set hive.cbo.enable;
set inceptor.join.discardnull;

set inceptor.filterjoin.enabled;
set inceptor.filterjoin.pushdown.filter.enabled;

-- Database - DO NOT DELETE OR CHANGE
CREATE DATABASE IF NOT EXISTS ${hiveconf:BIG_BENCH_DATABASE};
use ${hiveconf:BIG_BENCH_DATABASE};
