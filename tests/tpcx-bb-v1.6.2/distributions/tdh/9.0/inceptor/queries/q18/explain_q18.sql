...
ADD JAR ${hiveconf:BIG_BENCH_HDFS_ABSOLUTE_PATH}/${hiveconf:BIG_BENCH_HDFS_QUERY_RESOURCES}/opennlp-tools-1.9.3.jar;
ADD JAR ${hiveconf:BIG_BENCH_HDFS_ABSOLUTE_PATH}/${hiveconf:BIG_BENCH_HDFS_QUERY_RESOURCES}/bigbenchqueriesmr.jar;
CREATE TEMPORARY FUNCTION if not exists extract_NegSentiment AS 'io.bigdatabenchmark.v1.queries.q18.NegativeSentimentUDF';
