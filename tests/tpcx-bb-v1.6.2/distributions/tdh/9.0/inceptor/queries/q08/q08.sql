...
-- Resources
ADD FILE ${hiveconf:BIG_BENCH_HDFS_ABSOLUTE_PATH}/${hiveconf:BIG_BENCH_HDFS_QUERY_RESOURCES}/q08_filter_sales_with_reviews_viewed_before.py;
...
FROM ( -- sessionize clickstreams and filter "viewed reviews" by looking at the web_page page type using a python script
  ...
  REDUCE  wcs_user_sk,
          ...
          wcs_sales_sk,
          wp_type
  USING 'python3 q08_filter_sales_with_reviews_viewed_before.py review ${hiveconf:q08_seconds_before_purchase}'
...
--DROP TABLE IF EXISTS ${hiveconf:TEMP_TABLE3};
CREATE TABLE IF NOT EXISTS ${hiveconf:TEMP_TABLE3} (
   ws_net_paid     DECIMAL(7,2),
   ws_order_number    BIGINT
);

INSERT INTO ${hiveconf:TEMP_TABLE3}
