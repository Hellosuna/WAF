...
-- Resources
ADD FILE ${hiveconf:BIG_BENCH_HDFS_ABSOLUTE_PATH}/${hiveconf:BIG_BENCH_HDFS_QUERY_RESOURCES}/q03_filterLast_N_viewedItmes_within_y_days.py;
...
(
  ...
  ( -- sessionize and filter "last 5 viewed products after purchase of specific item" with reduce script
    ...
    USING 'python3 q03_filterLast_N_viewedItmes_within_y_days.py ${hiveconf:q03_days_in_sec_before_purchase} ${hiveconf:q03_views_before_purchase} ${hiveconf:q03_purchased_item_IN}'
