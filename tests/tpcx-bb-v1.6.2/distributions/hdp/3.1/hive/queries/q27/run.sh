...
query_run_validate_method () {
	...
	then
		...
		#echo "validating hdfs result $RESULT_DIR/delta_0000001_0000001_0000/* against $VALIDATION_RESULTS_FILENAME . diff -q \"$VALIDATION_RESULTS_FILENAME\" <(hadoop fs -cat \"$RESULT_DIR/delta_0000001_0000001_0000/*\""
		if diff -q "$VALIDATION_RESULTS_FILENAME" <(hadoop fs -cat "$RESULT_DIR/delta_0000001_0000001_0000/*")
		then
		...
		if [ `hadoop fs -cat "$RESULT_DIR/delta_0000001_0000001_0000/*" | head -n 10 | wc -l` -ge 1 ]
		then
