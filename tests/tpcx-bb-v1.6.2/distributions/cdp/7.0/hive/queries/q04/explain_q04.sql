...
-- Resources
ADD FILE ${hiveconf:BIG_BENCH_HDFS_ABSOLUTE_PATH}/${hiveconf:BIG_BENCH_HDFS_QUERY_RESOURCES}/q4_abandonedShoppingCarts.py;
ADD FILE ${hiveconf:BIG_BENCH_HDFS_ABSOLUTE_PATH}/${hiveconf:BIG_BENCH_HDFS_QUERY_RESOURCES}/q4_sessionize.py;
...
(
  ...
  REDUCE
    ...
    tstamp_inSec,
    wp_type
  USING 'python3 q4_sessionize.py ${hiveconf:q04_session_timeout_inSec}'
  AS (
    wp_type STRING,
