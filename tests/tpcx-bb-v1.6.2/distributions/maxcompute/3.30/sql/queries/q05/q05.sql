...
SELECT
  --wcs_user_sk,
  CASE WHEN clicks_in_category > avg_clicks_in_category then  1 else 0  end as clicks_in_category,
  college_education,
  male,
  clicks_in_1,
  clicks_in_2,
...
FROM
(
SELECT * , avg(clicks_in_category) over (partition by 1) avg_clicks_in_category
FROM
(
SELECT
  wcs_user_sk,
