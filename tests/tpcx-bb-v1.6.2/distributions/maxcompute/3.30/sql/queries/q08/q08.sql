...
-- Resources
--ADD JAR ${BIG_BENCH_QUERIES_DIR}/Resources/bigbenchqueriesudtf.jar as ${JAR_ALIAS_UDTF_ODPS} -f;
--DROP FUNCTION IF EXISTS ${PREFIX}_q08_filter_sales_with_reviews_viewed_before;
--CREATE FUNCTION ${PREFIX}_q08_filter_sales_with_reviews_viewed_before AS 'org.alidata.odps.udtf.bigbench.q08_filter_sales_with_reviews_viewed_before' using ${JAR_ALIAS_UDTF_ODPS};
ADD FILE ${QUERY_DIR}/q08_filter_sales_with_reviews_viewed_before.py -f;
set odps.sql.session.resources=q08_filter_sales_with_reviews_viewed_before.py;
