...
query_run_validate_method () {
	...
	then
                runCmdWithErrorCheck runEngineCmd --project=$BIG_BENCH_DATABASE -e "tunnel download -fd | $RESULT_TABLE $RESULT_FILE"
		...
		then
			...
			return 1
                ...
                runCmdWithErrorCheck runEngineCmd --project=$BIG_BENCH_DATABASE -e "tunnel download -fd | $RESULT_TABLE $RESULT_FILE -limit 10"
