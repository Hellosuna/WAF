...
--MaxCompute global setting --
--set odps.optimizer.cbo.remove.shuffle=true;
set odps.sql.decimal.odps2=true;
set odps.sql.mapper.split.size=1024;
set odps.sql.hive.compatible=true;
set odps.task.merge.enabled=false;
set odps.sql.preparse.odps2=lot;
set odps.sql.planner.parser.odps2=true;
set odps.optimizer.auto.mapjoin.threshold=2147483648;
set odps.sql.ddl.odps2=true;
set odps.optimizer.join.deliver.hashtrait=true;
set odps.optimizer.rowcount.use.recordnumber=true;
set odps.sql.planner.mode=lot;
set odps.optimizer.distribute.ordering.enable=true;
set odps.sql.ignore.detail.status=true;

set odps.sql.executionengine.batch.rowcount=10000;
set odps.sql.runtime.flag.executionengine_CompressCodec=zstd;
set odps.sql.disablecompress.instance.threshold=100000;
set odps.column.stat.enable=false;
set odps.merge.quickmerge.flag=true;
set odps.task.major.version=bigbench;
use ${BIG_BENCH_DATABASE};
